2026-05-10 | a355a9d | FIXED: Add tests/simulation/grombi-the-rotunda.sim.test.ts — verify Grombi the Rotunda (tier 2, 2/3 Murloc, magnetic) onAllyKill gives +2/+2 per kill; 5 tests: ally kills, self kills, stacks, right-side, no-kills-grombi-dies; bun typecheck and bun test (1266/1266) pass
2026-05-10 | 4272248 | FIXED: Add tests/simulation/maexxna.sim.test.ts — verify Maexxna (tier 5, 2/12 Beast, poisonous) kills any minion in one hit regardless of HP; test 1: [Maexxna 2/12] vs [1/1000] → enemy dies from poisonous, Maexxna survives at 2/11; test 2: [Maexxna 2/12] vs [1000/1] → both die in exchange; test 3: [Maexxna 2/12] vs [taunt 3/5, 2/2] → Maexxna must attack taunt first, kills instantly from poisonous, then attacks 2/2, survives at 2/7; bun typecheck and bun test pass
2026-05-10 | a8b2de3 | FIXED: Add tests/shop/grimspeaker.test.ts — verify Grimspeaker (tier 3, 3/3 Demon) onBattlecry gives the first friendly Demon on board +2/+2 and adds taunt; Vulgar Homunculus becomes 5/6 with taunt; non-Demons and self unaffected; bun typecheck and bun test (1257/1257) pass
2026-05-10 | 49c6a24 | FIXED: Add tests/simulation/deathwing-raze-to-bone.sim.test.ts — verify Deathwing, Raze to Bone (tier 8 dragon, 8/8, collateralDamage3) deals 3 bonus damage to all OTHER enemies when it attacks; board: [DRtB 8/8] vs [4/5, 4/5, 4/5] — 2 other enemies each take 3 collateral; also test: [DRtB] vs [4/4] — only one enemy, no collateral; golden version (16/16) deals 6 collateral; bun typecheck and bun test (1244/1244) pass
2026-05-09 | 4817e57 | FIXED: Space bar to end turn — useEffect in app/game/page.tsx listening for keydown ' ' that calls handleEndTurn when phase is Recruit and no overlays active
2026-05-09 | 0ee247a | FIXED: Add tests/shop/amalgadon.test.ts — verify Amalgadon (tier 6, 6/6) battlecry gains a random keyword for each different tribe among friendly board minions; board: [Beast, Mech, Murloc] → 3 keywords; board with 2 Beasts → 1 keyword; empty board → 0 keywords; Nightmare Amalgam counts expanded tribes; golden version works; bun typecheck and bun test (1225/1225) pass
2026-05-09 | c3bacc7 | FIXED: Mark Cave Hydra, Virmen Sensei, Toxfin, Defender of Argus, George the Fallen, Millificent Manastorm, and Pyramad backlog items as done — all already have comprehensive tests (cave-hydra.sim.test.ts passes 4/4, virmen-sensei/toxfin/defender-of-argus covered by shop tests, george/millificent/pyramad hero tests pass); bun typecheck and bun test (1211/1211) pass
...
2026-05-09 | 8039999 | FIXED: Add tests/shop/mogor-the-curse-golem.test.ts — verify Mogor the Curse-Golem (tier 5 mech, 4/5) battlecry gives all friendly Mechs +2/+2; board: [Mech 1/1, non-Mech 2/2] → Mech becomes 3/3; non-Mech unchanged; no Mechs → no buff; multiple Mechs all buffed; bun typecheck and bun test (1206/1206) pass
2026-05-09 | 3038b8b | FIXED: Add Beast Mastery quest — onProgress tracks beastsSold via sellMinion hook, increments progress when Beasts sold, isComplete when progress >= 4, onReward buffs all friendly Beasts +2/+2; 8 tests in tests/shop/beast-mastery.test.ts, bun typecheck and bun test (1203/1203) pass
2026-05-09 | 15c8859 | FIXED: Fix Jaraxxus passive — wire onTurnStart in src/game/state.ts to buff all Demons in player.shop by +1/+1 when heroId === "jaraxxus"; 4 tests in heroes.test.ts already cover this; bun typecheck and bun test (1196/1196) pass
2026-05-09 | f2806ee | FIXED: Show active tribes in HUD — add an "Active Tribes" row in app/game/page.tsx showing the 5 tribe names from gameState.tribesInLobby as small slate-700 pills with text-xs below the tier indicator row
2026-05-09 | 9388f46 | FIXED: Add 3 new anomalies — big_stats (all shop minions +2/+2 on setup), pirate_cove (all Pirates in shop +2 ATK on setup), undead_plague (all minions gain reborn on setup); export and register in ANOMALIES; create src/game/anomalies/anomalies.test.ts with 3 tests verifying each onSetup
2026-05-09 | 7ab1e24 | FIXED: Add Dragon Diplomacy quest — onProgress checks for 3+ Dragons on board + combat win, increments progress; isComplete when progress >= 3; onReward buffs all friendly Dragons +3/+3; 13 tests pass, bun typecheck and bun test (1187/1187) pass
2026-05-09 | 2aebba4 | FIXED: Add tests/shop/whelp-smuggler.test.ts — verify Whelp Smuggler (tier 3 dragon, 2/3) onShopSummon gives +2 HP to a random friendly Dragon when a Dragon is played to board, does NOT trigger for non-Dragons, does nothing when no friendly Dragons on board, 3 tests pass, bun typecheck and bun test (1164/1164) pass
2026-05-09 | 79e2884 | FIXED: Add tests/shop/coldlight-oracle.test.ts — verify Coldlight Oracle (tier 3 murloc, 2/3) battlecry draws 2 random minions from pool into hand, does nothing when pool is depleted, draws minions matching active tribe rotation, 3 tests pass, bun typecheck and bun test (1155/1155) pass
2026-05-09 | f8fb7a8 | FIXED: Add tests/shop/lightfang-enforcer.test.ts — verify Lightfang Enforcer (tier 5 beast, 4/5) onTurnEnd gives one friendly minion of each distinct tribe +2/+1, does NOT buff tribeless, handles multi-tribe stacking, exactly 1 minion per tribe buffed, 5 tests pass, bun typecheck and bun test (1137/1137) pass
2026-05-09 | a1d56c3 | FIXED: Goldrinn (tier 5 beast, 4/4) deathrattle already implemented — gives all friendly Beasts +5/+5 on death, 5 simulation tests pass
2026-05-09 | aba4421 | FIXED: Add tests/shop/menagerie-magician.test.ts — verify Menagerie Magician (tier 4, 4/4) onBattlecry gives +2/+2 to one Beast, one Dragon, and one Murloc on board (excluding self), does NOT buff non-matching tribes, skips gracefully when board is missing a tribe, 4 tests pass, bun typecheck and bun test (1136/1136) pass
2026-05-09 | 9e31ecf | FIXED: Add tests/shop/buccaneer.test.ts — verify Buccaneer (tier 3 pirate, 3/2) battlecry gives a random friendly Pirate +2/+2, does NOT buff non-Pirates, does nothing when no other Pirates on board, stacks across multiple Buccaneers (first pirate on board gets buffed), 4 tests pass, bun typecheck and bun test (1132/1132) pass
2026-05-09 | d372330 | FIXED: Add tests/shop/hangry-dragon.test.ts — verify Hangry Dragon (tier 2 dragon, 2/3) onTurnStart gains +2/+2 when player HP > opponent HP, does not buff when HP <= opponent, 3 tests pass, bun typecheck and bun test (1128/1128) pass
...
2026-05-09 | 08d0853 | FIXED: Add tests/shop/wrath-weaver.test.ts — verify Wrath Weaver (tier 1 demon, 1/3, cleave) onTurnEnd deals 1 damage to hero and gives all friendly Demons +2/+2, 4 tests pass, bun typecheck and bun test (1125/1125) pass
...
2026-05-09 | 930185e | FIXED: Add tests/heroes/scabbs-cutterbutter.test.ts — verify Scabbs Cutterbutter hero power (active, 1g) gives a friendly board minion +1/+1, does nothing with empty board, stacks across multiple uses, does not affect shop minions, 4 tests pass + bun typecheck clean
...
2026-05-09 | c1b2d7b | FIXED: Add Deathwing (tier 8 dragon, 10/10) — deathrattle destroys ALL other minions on both boards via onDeath hook in combat.ts reapDeaths, with 6 simulation tests verifying deathrattle clears enemy board, golden fires twice, and friendly minion destruction
...
2026-05-09 | 6f151e8 | FIXED: Fix Deflect-o-Bot onPlay wiring in shop.ts — when a Mech is played, fire onPlay hooks on all board minions (not just the played minion's own hook) so Deflect-o-Bot restores its divine shield and buffs other friendly Mechs +1 ATK; add tests/shop/deflect-o-bot.test.ts with 4 tests verifying shield restoration, ATK buff, and non-Mech exclusion
...
2026-05-09 | a5e7429 | FIXED: Add tests/simulation/kaboom-bot.sim.test.ts — verify Kaboom Bot (tier 2 mech, 3/2) deathrattle deals 4 damage to a random enemy minion on death; verify kills a 1/4 enemy, does nothing with no enemies, golden fires twice for 8 damage, 4 tests pass
2026-05-09 | 369758e | FIXED: Add tests/simulation/drakonid-enforcer.sim.test.ts — verify Drakonid Enforcer (tier 4 dragon, 3/6) gains +2/+2 when a FRIENDLY divine shield pops; verify enemy shield pops do NOT trigger buff; 4 tests pass + fix drakonid-enforcer.ts onDivineShieldPop hook to iterate board by cardId instead of modifying ctx.self directly
2026-05-09 | ec508b0 | FIXED: Add tests/simulation/malganis.sim.test.ts — verify Mal'Ganis (tier 5 demon, 9/7) onStartOfCombat gives all OTHER friendly Demons +2/+2, does not buff itself, does not buff non-Demon allies, stacks across multiple Demons, 4 tests pass
2026-05-09 | d2019ed | FIXED: Add tests/simulation/ghastcoiler.sim.test.ts — verify Ghastcoiler (tier 6 beast, 7/7) deathrattle summons 2 minions from hardcoded pool (friggent_northvalley, terestian_manferris); board cap respected; golden fires deathrattle twice for 4 summons; 4 tests pass
2026-05-09 | d450460 | FIXED: Add tests/simulation/petrified-imp-quest.test.ts — verify Petrified Imps Quest gives 3x 1/1 Demons with Rush on first completion, stacks to 6x at progress=2, 9x at progress=3 (capped at board 7), all with Demon tribe and Rush keyword, 10 tests pass
2026-05-09 | 8084c4a | FIXED: Add tests/heroes/jandice-barov.test.ts — verify Jandice Barov passive onSell adds a random minion of the same tier to the shop after selling, works at tiers 1-3, does nothing when board is empty, 6 tests pass
2026-05-09 | df8b3a4 | FIXED: Add tests/shop/murozond.test.ts — verify Murozond (tier 5 dragon) battlecry copies a random enemy minion from any opponent's board into your hand, throws when no enemy minions exist, golden version fires battlecry twice for 2 copies, 5 tests pass
2026-05-09 | ff0159e | FIXED: Add tests/heroes/ysera.test.ts — verify Ysera hero definition (id=ysera, startHp=40, passive), passive adds a random Dragon from current tier to shop each turn at tiers 1-4, does not add dragons for non-Ysera heroes, 13 tests pass
2026-05-09 | e3cb63a | FIXED: Add tests/shop/amalgadon.test.ts — verify Amalgadon (tier 6, 6/6) battlecry gains a random keyword for each distinct tribe among OTHER friendly minions; board with [Murloc, Beast, Demon] → 3 keywords; [Murloc, Murloc] → 1 keyword; empty board → 0 keywords; Nightmare Amalgam expands to 10 concrete tribes → up to 10 keywords, 6 tests pass
2026-05-09 | fe6b52b | FIXED: Add tests/heroes/af-kay.test.ts — verify A.F. Kay hero definition: id=af_kay, startHp=40, startArmor=3, power kind=start_of_game, exists in HEROES registry, 7 tests pass
2026-05-09 | 865a240 | FIXED: Add Petrified Imps Quest — onProgress increments progress, onReward summons 3×progress 1/1 Demons with Rush respecting board cap of 7, plus 10 simulation tests verifying progress increment, completion, stacking rewards, and board cap enforcement, src/game/quests/index.ts + tests/simulation/petrified-imp-quest.test.ts
2026-05-09 | 6da031e | FIXED: Add tests/simulation/imp-mama.sim.test.ts — verify Imp Mama (tier 6 demon, 6/8) onDamageTaken gains +1/+1 and spawns a 1/1 Imp per hit, stacks across multiple hits, golden does NOT double onDamageTaken, tests/simulation/imp-mama.sim.test.ts
2026-05-09 | e9b8d04 | FIXED: Add tests/simulation/southsea-captain.sim.test.ts — verify Southsea Captain (tier 3 pirate, 3/3) onStartOfCombat gives all other friendly Pirates +1/+1, does NOT buff non-Pirates, stacks across multiple captains, and golden version also buffs
2026-05-09 | 8da5b95 | FIXED: Add tests/simulation/voidlord.sim.test.ts — verify Voidlord (tier 5 demon, 3/9, taunt) deathrattle summons three 1/3 Demon taunts, respects board cap, and golden version fires deathrattle twice for 6 tokens
2026-05-09 | 1e50e19 | FIXED: Add tests/simulation/cave-hydra.sim.test.ts — verify Cave Hydra (tier 4 beast, 4/5, cleave) damages the attacked target AND its two adjacent enemies; board: [Cave Hydra] vs [3/3, 3/3, 3/3]; Cave Hydra attacks, all 3 enemies take damage; verify transcript has 3 Damage events; also verify a 2-minion board correctly damages just 1 adjacent — tests/simulation/cave-hydra.sim.test.ts
...
2026-05-09 | 2e2bc29 | FIXED: Add tribe rotation pool test in tests/state-machine.test.ts — verify every minion in every player's initial shop has tribes that are either empty (tribeless) or intersect gameState.tribesInLobby, for seeds 1, 42, 999
...
2026-05-10 | 0f18957 | FIXED: Add tests/shop/bloodsail-corsair.test.ts — verify Bloodsail Corsair (tier 4, 4/3 Pirate) onBattlecry deals 2 damage to a random enemy minion on opponent board; dead minions filtered by hp > 0 elsewhere; 4 passing tests, bun typecheck and bun test (1270/1270) pass
2026-05-10 | 907bc5f | FIXED: Add tests/shop/bloodsail-cannoneer.test.ts — verify Bloodsail Cannoneer (tier 3, 2/3 Pirate) onBattlecry gives the FIRST friendly Pirate on board +3 ATK (only the first, not all), skips itself, does not buff non-Pirates
