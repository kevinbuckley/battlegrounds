2026-05-03 | 5ce4ea4 | FIXED: Add Nightmare Amalgam (tier 2) — no tribe vanilla 2/4 that counts as ALL tribes for tribe-buff effects, with "All" expanded to all 10 tribes at instantiation time, plus unit tests
