2026-05-09 | 58ed203 | FIXED: Opponent elimination toasts — in handleEndTurn after step() resolves, compare pre/post player HP; for any opponent who newly has hp ≤ 0, push a 3s toast message "💀 HeroName has been eliminated!" using a toasts state array with auto-clear via setTimeout, rendered below victory banner
