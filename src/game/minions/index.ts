...
import murlocKnight from "./tier1/murloc-knight";
...
import southseaCaptain from "./tier3/southsea-captain";
...
import gnomaTinkerT4 from "./tier4/gnoma-tinker";
import houndmasterShaw from "./tier4/houndmaster-shaw";
...
import nadina from "./tier6/nadina";
...
export const MINIONS: Record<MinionCardId, MinionCard> = {
  ...
  [southseaCaptain.id]: southseaCaptain,
